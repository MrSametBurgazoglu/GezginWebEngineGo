...
func (receiver *HtmlTagHtml) Render(renderer *sdl.Renderer, resourceManager *ResourceManager.ResourceManager) {

}

func SetWidgetPropertiesForHtmlTag(element *HtmlParser.HtmlElement) WidgetInterface {
