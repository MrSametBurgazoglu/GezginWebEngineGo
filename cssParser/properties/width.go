...
func SetWidth(cssProperties *structs.CssProperties, value string) {
...
func SetMinWidth(cssProperties *structs.CssProperties, value string) {
	if strings.HasSuffix(value, "px") {
		width, err := strconv.Atoi(strings.TrimSuffix(value, "px"))
		if err != nil {
			// handle error
...
func SetMaxWidth(cssProperties *structs.CssProperties, value string) {
	if strings.HasSuffix(value, "px") {
		width, err := strconv.Atoi(strings.TrimSuffix(value, "px"))
		if err != nil {
			// handle error
...
func WidthPropertySetValue(cssProperties *structs.CssProperties, value string) {
	if value == "inherit" {
...
func MinWidthPropertySetValue(cssProperties *structs.CssProperties, value string) {
	if value == "inherit" {
...
func MaxWidthPropertySetValue(cssProperties *structs.CssProperties, value string) {
	if value == "inherit" {
...
func ComputeInheritWidth(dest, source *structs.CssProperties) {
...
func UpdateWidth(cssProperties, source *structs.CssProperties) {
