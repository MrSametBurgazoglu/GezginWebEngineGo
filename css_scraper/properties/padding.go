...
func PaddingTopPropertySetValue(currentWidget *structs.CssProperties, value string) {
	if value == "inherit" {
...
func PaddingBottomPropertySetValue(currentWidget *structs.CssProperties, value string) {
	if value == "inherit" {
		if !currentWidget.PaddingInherit {
			if currentWidget.Padding == nil {
				currentWidget.Padding = new(structs.Padding)
...
func PaddingLeftPropertyValue(currentWidget *structs.CssProperties, value string) {
	if value == "inherit" {
		if !currentWidget.PaddingInherit {
			if currentWidget.Padding == nil {
				currentWidget.Padding = new(structs.Padding)
...
func PaddingRightPropertySetValue(currentWidget *structs.CssProperties, value string) {
	if value == "inherit" {
		if !currentWidget.PaddingInherit {
			if currentWidget.Padding == nil {
				currentWidget.Padding = new(structs.Padding)
...
func PaddingPropertySetValue(currentWidget *structs.CssProperties, value string) {
	if value == "inherit" {
